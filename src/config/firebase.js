...
export const FIREBASE_DATABASE_URL = (
    process.env.REACT_APP_FIREBASE_DATABASE_URL || DEFAULT_DATABASE_URL
).replace(/\/$/, '');

export const FIREBASE_PROJECT_ID =
    process.env.REACT_APP_FIREBASE_PROJECT_ID || 'test-prod-app-81915';

export const firebaseDbUrl = (path) =>
    `${FIREBASE_DATABASE_URL}/${String(path || '').replace(/^\//, '')}`;
